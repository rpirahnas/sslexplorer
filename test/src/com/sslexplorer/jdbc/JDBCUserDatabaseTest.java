...
public class JDBCUserDatabaseTest extends AbstractTest {
    ...
    public void simpleCreateUser() throws Exception {
        User user = createAccount("jb", "qwqwqw", "james@3sp.com", "James Robinson");
    ...
    public void createNUsers() throws Exception {
        User user1 = createAccount("jb1", "qwqwqw", "james@3sp.com", "James Robinson1");
        User user2 = createAccount("jb2", "qwqwqw", "james@3sp.com", "James Robinson2");
        User user3 = createAccount("jb3", "qwqwqw", "james@3sp.com", "James Robinson3");
        assertEquals("There should only be the one user and he is the super user.", getDefaultUserDatabase().listAllUsers(
    ...
    public void loginSuccessfull() throws Exception {
        ...
        User user = createAccount(username, password, "james@3sp.com", "James Robinson");
    ...
    public void cantChangeUsername() throws Exception {
        String username = "jb";
        User user = createAccount(username, "qwqwqw", "ja,es@3sp.com", "James Robninson");
    ...
    public void updateUserChangeFullName() throws Exception {
        ...
        String username = "jb";
        User user = createAccount(username, "qwqwqw", "ja,es@3sp.com", fullName);
    ...
    public void assignRolesToUser() throws Exception {
        ...
        User user = createAccount(userName, "qwqwqw", "james@3sp.com", "James Robninson");
    ...
    public void listingUsers() throws Exception {
        ...
        User user2 = createAccount("abbb", "abbb", "abbb@3sp.com", "ABBB");
        User user3 = createAccount("aabb", "aabb", "aabb@3sp.com", "AABB");
        User user4 = createAccount("aaab", "aaab", "aaab@3sp.com", "AAAB");
        User user5 = createAccount("bbbb", "bbbb", "bbbb@3sp.com", "BBBB");
        User user6 = createAccount("xaax", "xaax", "xaax@3sp.com", "XAAX");
