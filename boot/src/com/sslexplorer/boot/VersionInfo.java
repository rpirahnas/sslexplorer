...
/**
 * Get the version of SSL Explorer in use. If running in a development
...
public class VersionInfo {
    ...
    private final static String VERSION = "1.0.0_RC17";
    ...
    static {
        if (VERSION.startsWith("999.")) {
            ...
            try {
                ...
                version = new Version("1.0.0_RC17");
            } finally {
                if (in != null) {
                    try {
                        in.close();
     ...
     * {@link #VERSION} has not been replaced (i.e. is 1.0.0_RC17).
     * 
    ...
    /**
     * Get the current SSL-Explorer version
     * 
     * @return version
     */
