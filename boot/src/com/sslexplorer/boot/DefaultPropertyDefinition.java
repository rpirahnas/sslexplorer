 ...
 * <code>com.sslexplorer.input.validators.IntegerValidator(minValue=10,maxValue=20)</code>.
 * 
 */
public class DefaultPropertyDefinition implements PropertyDefinition, Comparable<PropertyDefinition>, Serializable {
        ...
        switch (type) {
            ...
            case TYPE_INTEGER:
                if (this.validationString == null || this.validationString.equals("")) {
                    this.validationString = "com.sslexplorer.input.validators.IntegerValidator(replacementVariables="
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#validate(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#isRestartRequired()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#setValidationString(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getPropertyClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#init(com.sslexplorer.boot.PropertyClass)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#formatAttributeValue(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#parseValue(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#setVisibility(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getDescriptionMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getNameMessageResourceKey()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getCategoryLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getLabel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#setCategoryLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#setLabel(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#getDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDefinition#setDescription(java.lang.String)
     */
