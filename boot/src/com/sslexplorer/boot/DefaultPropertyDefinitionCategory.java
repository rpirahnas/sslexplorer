...
public class DefaultPropertyDefinitionCategory implements PropertyDefinitionCategory, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getParent()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getBundle()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getImagePath()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#addCategory(com.sslexplorer.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#removeCategory(com.sslexplorer.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#setParent(com.sslexplorer.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#size()
     */
    public int size() {
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getCategories()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#contains(com.sslexplorer.properties.PropertyDefinitionCategory)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#isEnabled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#setEnabled(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#getPropertyClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDefinitionCategory#setPropertyClass(com.sslexplorer.boot.PropertyClass)
     */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.boot.PropertyDefinitionCategory#getDefinitions()
	 */
