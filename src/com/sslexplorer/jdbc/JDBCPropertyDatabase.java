...
import com.sslexplorer.properties.attributes.AbstractAttributeKey;
...
public class JDBCPropertyDatabase implements PropertyDatabase {
    ...
    final static Long CACHE_TTL = new Long(SystemProperties.get("sslexplorer.jdbcPropertyDatabase.cacheTTL", "180000"));
    final static Integer CACHE_MAXOBJS = new Integer(SystemProperties.get("sslexplorer.jdbcPropertyDatabase.cacheMaxObjs", "2000"));
    ...
    public void open(CoreServlet controllingServlet) throws Exception {
        String dbName = SystemProperties.get("sslexplorer.propertyDatabase.jdbc.dbName", "explorer_configuration");
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.PropertyDatabase#storeProperty(int,
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.properties.PropertyDatabase#getPropertyProfiles(java.lang.String, boolean, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.properties.PropertyDatabase#createPropertyProfile(java.lang.String, java.lang.String, java.lang.String, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.properties.PropertyDatabase#updatePropertyProfile(int, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.properties.PropertyDatabase#getPropertyProfile(java.lang.String, java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDatabase#createAttributeDefinition(com.sslexplorer.properties.AttributeDefinition)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDatabase#deleteAttributeDefinition(java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.PropertyDatabase#updateAttributeDefinition(com.sslexplorer.properties.AttributeDefinition)
     */
