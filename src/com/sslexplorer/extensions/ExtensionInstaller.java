...
import com.sslexplorer.core.stringreplacement.ExtensionBundleReplacer;
 ...
 * {@link #addOp(com.sslexplorer.extensions.ExtensionInstaller.ExtensionInstallOp)}.
...
public class ExtensionInstaller {
	...
	public static abstract class AbstractExtensionInstallOp implements ExtensionInstallOp {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.sslexplorer.extensions.ExtensionInstaller.ExtensionInstallOp#getPhase()
		 */
		public String getPhase() {
			return phase;
		}
	...
	public static class MkdirInstallOp extends AbstractExtensionInstallOp {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.sslexplorer.extensions.ExtensionInstaller.ExtensionInstallOp#doOp(com.sslexplorer.extensions.ExtensionInstaller)
		 */
		public void doOp(ExtensionInstaller install) throws Exception {
