...
public class DefaultPlugin extends AbstractPlugin {
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.extensions.types.Plugin#startPlugin(com.sslexplorer.extensions.types.PluginDefinition, com.sslexplorer.extensions.ExtensionDescriptor, org.jdom.Element)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.extensions.types.Plugin#activatePlugin()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.extensions.types.Plugin#stopPlugin()
     */
