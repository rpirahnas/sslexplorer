...
public class ExtensionException extends CoreException {
	...
	/**
	 * The version of SSL-Explorer hosting the plugin is not sufficient. Arg0 is
	 * the plugin name, Arg1 is the required version
	 */
	public static final int INSUFFICIENT_SSLEXPLORER_HOST_VERSION = 9;
	...
	protected MessageResources getMessageResources(String bundleName) {
		...
		if(mr == null) {
			...
			mr = fact.createResources("com.sslexplorer.errors.ApplicationResources");
		}
		return mr;
	}
