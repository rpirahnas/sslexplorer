...
package com.sslexplorer.language.actions;
...
import com.sslexplorer.core.ErrorConstants;
...
public class SelectLanguageAction extends DefaultAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie cookie = new Cookie(SystemProperties.get("sslexplorer.cookie", "SSLX_SSESHID") + "_LANG", locale.toString());
