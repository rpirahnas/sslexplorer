 ...
 * 
 * @see com.sslexplorer.install.forms.ConfigureSuperUserForm
 */
public class ConfigureSuperUserAction extends AbstractInstallWizardAction {
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.wizard.actions.AbstractWizardAction#previous(org.apache.struts.action.ActionMapping,
