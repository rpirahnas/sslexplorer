...
package com.sslexplorer.properties.attributes.wizards.forms;
...
import com.sslexplorer.properties.attributes.forms.AttributeDefinitionForm;
import com.sslexplorer.properties.attributes.wizards.actions.AttributeDefinitionDetailsAction;
import com.sslexplorer.properties.attributes.wizards.actions.AttributeDefinitionOptionsAction;
...
public class AttributeDefinitionOptionsForm extends DefaultWizardForm {
    ...
    public void init(AbstractWizardSequence sequence, HttpServletRequest request) throws Exception {
        ...
        validationString  = (String)sequence.getAttribute(AttributeDefinitionOptionsAction.ATTR_VALIDATION_STRING, "com.sslexplorer.input.validators.StringValidator(minLength=0,maxLength=30,trim=true,regExp=,pattern=)");
