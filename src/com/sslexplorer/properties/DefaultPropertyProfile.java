...
/**
 * Default implementation of a {@link com.sslexplorer.properties.PropertyProfile}.
 */
public class DefaultPropertyProfile extends AbstractResource implements PropertyProfile {
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.boot.PropertyProfile#getLabel()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.boot.policyframework.OwnedResource#getOwnerUsername()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.policyframework.AbstractResource#compareTo(java.lang.Object)
     */
