...
public abstract class AbstractResource implements Resource, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.boot.policyframework.Resource#getResourceDisplayName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.policyframework.Resource#getRealmID()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.policyframework.ResourceType#getLaunchRequirement()
     */
