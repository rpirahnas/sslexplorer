...
package com.sslexplorer.keystore.actions;
...
public class GenerateServerCertificateCSRAction extends AuthenticatedAction {
    ...
    public ActionForward onExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        return new ActionForward(SystemProperties.get("sslexplorer.certificatePurchaseLink", "http://3sp.com/showSslCertificates.do"), true);
    }

    /* (non-Javadoc)
     * @see com.sslexplorer.core.actions.AuthenticatedAction#getNavigationContext(org.apache.struts.action.ActionMapping, org.apache.struts.action.ActionForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
