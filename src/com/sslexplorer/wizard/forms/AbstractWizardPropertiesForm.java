...
package com.sslexplorer.wizard.forms;
...
import com.sslexplorer.properties.PropertyItemImpl;
...
public abstract class AbstractWizardPropertiesForm extends AbstractWizardForm implements PropertiesForm, TabModel {
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#getCategoryDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#getEnabled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#getParentCategory()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#getPropertyItem(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#getPropertyItems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#setCategoryDefinitions(java.util.List)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#setPropertyItem(int,
     *      com.sslexplorer.applications.PropertyItem)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sslexplorer.properties.forms.PropertiesForm#setPropertyItems(com.sslexplorer.applications.PropertyItem[])
     */
