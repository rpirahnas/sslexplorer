...
import com.sslexplorer.core.RequestParameterMap;
import com.sslexplorer.core.UserDatabaseManager;

/**
 * Abstract implementation of an {@link com.sslexplorer.security.AuthenticationModule}
 * that simply checks the supplied authentication details against the information
 * in the current {@link com.sslexplorer.security.UserDatabase}.
 */
public abstract class AbstractPasswordAuthenticationModule implements AuthenticationModule {
     ...
     * (non-Javadoc)
     *
     * @see com.sslexplorer.security.AuthenticationModule#getName()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.security.AuthenticationModule#authenticate(javax.servlet.http.HttpServletRequest, com.sslexplorer.core.RequestParameterMap)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.sslexplorer.security.AuthenticationModule#init(com.sslexplorer.security.AuthenticationSession)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.sslexplorer.security.AuthenticationModule#startAuthentication(javax.servlet.http.HttpServletRequest,
     ...
     * (non-Javadoc)
     *
     * @see com.sslexplorer.security.AuthenticationModule#isRequired()
     */
