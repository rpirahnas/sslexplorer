...
import com.sslexplorer.security.IpRestrictionItem;
import com.sslexplorer.security.IpRestrictionItemModel;
import com.sslexplorer.table.forms.AbstractPagerForm;

/**
 * Implementation of a {@link com.sslexplorer.table.forms.AbstractPagerForm}
...
public class ShowAvailableIpRestrictionsForm extends AbstractPagerForm {
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.table.forms.AbstractPagerForm#reset(org.apache.struts.action.ActionMapping, javax.servlet.http.HttpServletRequest)
     */
