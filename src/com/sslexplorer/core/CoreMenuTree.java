...
public class CoreMenuTree extends MenuTree {
    ...
    public CoreMenuTree() {
        ...
        addMenuItem("help", new MenuItem("referenceGuidePDF", "navigation", "http://3sp.com/products/ssl-explorer/documentation/SSL-Explorer_Administrators_Guide.pdf", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        addMenuItem("help", new MenuItem("referenceGuideHTML", "navigation", "http://3sp.com/products/ssl-explorer/documentation/html/w2wfrm.htm", 300, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        // Documentation
        addMenuItem("help", new MenuItem("knowledgeBase", "navigation", "http://3sp.com/kb", 400, true, "_blank",
            SessionInfo.HELP_CONTEXT));

        addMenuItem("help", new MenuItem("support", "navigation", "http://3sp.com/showSslExplorer.do", 500, true, "_blank", SessionInfo.HELP_CONTEXT));
        
        
        addMenuItem("help", new MenuItem("forums", "navigation", "http://3sp.com/forums", 600, true, "_blank",
                SessionInfo.HELP_CONTEXT));


        addMenuItem("help", new MenuItem("communityWiki", "navigation", "http://3sp.com/", 700, true, "_blank",SessionInfo.HELP_CONTEXT));
    }
