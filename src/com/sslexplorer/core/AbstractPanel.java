...
/**
 * Abstract implementation of a {@link com.sslexplorer.core.Panel}.
 */
public abstract class AbstractPanel implements Panel {
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#isDropable()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#isDragable()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getPlacement()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getWeight()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getId()
     */
    public String getId() {
        return id;
    }
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getBundle()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getTileIncludePath(javax.servlet.jsp.PageContext)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#isCloseable()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#getDefaultFrameState()
     */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.core.Panel#setDragable(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.core.Panel#setDropable(boolean)
	 */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.core.Panel#isMinimizable()
     */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.core.Panel#setMinimizable(boolean)
	 */
