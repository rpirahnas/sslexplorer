...
public abstract class AbstractStore implements VFSStore {
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.vfs.VFSStore#getMountPath(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getEncoding()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getName()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getGuestUsername()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getGuestPassword()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#init(com.sslexplorer.vfs.VFSRepository, com.sslexplorer.vfs.VFSProvider)
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getProvider()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getRepository()
     */
    ...
    /* (non-Javadoc)
     * @see com.sslexplorer.vfs.VFSStore#getStoreResource()
     */
