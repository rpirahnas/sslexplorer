...
/**
 * A store is a child of a {@link com.sslexplorer.vfs.VFSRepository}
 * and  provides the entry point for a particular type of file system
 * (e.g. Local, SMB, FTP etc). 
 * <p>
 * It returns a list of {@link com.sslexplorer.vfs.VFSMount} objects
 ...
 * {@link com.sslexplorer.vfs.VFSProviderManager#registerStore(Class)}.
 * 
 * @see com.sslexplorer.vfs.VFSProviderManager
 */
public interface VFSStore {
     ...
     * @return mount
     * @throws DAVException on any error.
     * @throws DAVAuthenticationRequiredException if SSL-Explorer authentication is required for the mount
     */
