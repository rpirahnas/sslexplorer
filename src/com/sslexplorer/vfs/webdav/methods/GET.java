...
import com.sslexplorer.vfs.VFSLockManager;
import com.sslexplorer.vfs.VFSResource;
import com.sslexplorer.vfs.webdav.DAVTransaction;
import com.sslexplorer.vfs.webdav.LockedException;
    	...
    	try {
	        ...
	        try {
	            if (resource.isCollection() || resource.isMount()) {
	            	...
	            	if(SystemProperties.get("sslexplorer.disableFolderBrowsing", "true").equals("true") && !resource.isBrowsable()) {
	                ...
	                if (parent != null && (parent.isBrowsable() || !SystemProperties.get("sslexplorer.disableFolderBrowsing", "true").equals("true"))) {
		                out.println("<tr>");
