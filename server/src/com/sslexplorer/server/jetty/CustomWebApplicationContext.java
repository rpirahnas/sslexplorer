...
public class CustomWebApplicationContext extends WebApplicationContext {
    ...
    public CustomWebApplicationContext(boolean useDevConfig, ClassLoader bootLoader) throws Exception {
        ...
        if("true".equals(SystemProperties.get("sslexplorer.paranoidSessionManager", "true"))) {
    ...
    public Resource getResource(String pathInContext) throws IOException {
        boolean fullResourceCache = SystemProperties.get("sslexplorer.fullResourceCache",
            String.valueOf(!(SystemProperties.get("sslexplorer.useDevConfig", "false").equals("true")))).equals("true");
        Resource r;
