...
public class SwingBootProgressMonitor implements BootProgressMonitor {
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.boot.BootProgressMonitor#updateMessage(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.boot.BootProgressMonitor#updateProgress(int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.sslexplorer.boot.BootProgressMonitor#dispose()
	 */
	public void dispose() {
		if(monitor != null) {
			monitor.hide();
